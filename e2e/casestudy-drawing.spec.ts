...
/**
 * Manual screenshot generator for the figure navigator and the drawing check, run against
 * PUBLIC Apple material (US 2012/0024859 A1, FIG. 1 and FIG. 6). It makes a live Grok vision
 * call, so it is skipped in the normal gate. Regenerate case-drawing.png with:
...
test("figures: navigator across views and drawing check", async ({
  page,
}) => {
  ...
  // Two views: a perspective figure and a top figure.
  ...
  await page.getByRole("button", { name: "1. Perspective" }).click();
