...
const ITEMS = [
  {
    ...
    body: "A research aid. What you file stays your responsibility.",
  },
  {
    icon: Ban,
    title: "It never files for you",
    body: "It prepares the documents. You file them.",
  },
  {
    icon: Gauge,
    title: "No single patentability score",
    body: "Overlaps stay itemized so you judge the picture, not a number.",
  },
  {
    icon: BookOpen,
    title: "Every citation resolves to real text",
    body: "Nothing reaches the screen without the real MPEP or CFR passage behind it.",
  },
  {
    icon: Lock,
    title: "Encrypted, US region storage",
    body: "Files are encrypted, stored in the US, and isolated to your account.",
  },
  {
    icon: ShieldCheck,
  ...
  return (
    <section id="trust" className="scroll-mt-20">
      <div className="mx-auto w-full max-w-6xl px-6 py-20 lg:py-28">
        <BlurFade inView>
          <SectionEyebrow n="0005">Trust</SectionEyebrow>
        </BlurFade>
