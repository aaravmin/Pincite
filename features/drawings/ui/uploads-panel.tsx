...
import { deleteAttachment, classifyOrientation } from "@/features/drawings/actions";
import { FigureNavigator } from "@/features/drawings/ui/figure-navigator";
import {
  ATTACHMENT_VIEWS,
...
export function UploadsPanel({
  ...
  const figures = initial.filter(isDrawing);
