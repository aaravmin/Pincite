 ...
 * ones that do not resolve (the CFR reference still shows). This is the core citation
 * discipline: no claim reaches the screen without a citation that resolves to real text.
 * It lives in the application layer because it needs the corpus; `lifecycleActions`
 * itself stays pure.
 */
