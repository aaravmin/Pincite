 ...
 * validated against the corpus by application/resolve-lifecycle-pins before display, so
 * nothing reaches the screen citing text that is not in the corpus.
 */
import type { ProjectStatus, PatentType } from "@/features/projects/domain/sections";
