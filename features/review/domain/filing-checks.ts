 ...
 * Each carries a CFR reference (display-only) and an MPEP pin. This module is pure: the pin is
 * validated against the corpus (and dropped if unresolved) one layer up, in
 * features/review/application/resolve-pins.ts, honoring the anti-hallucination discipline.
 */
